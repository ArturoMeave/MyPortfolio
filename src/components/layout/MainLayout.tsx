    ...
    <div className="relative min-h-screen bg-black text-white selection:bg-orange-500/30">
      ...
      <div className="relative z-10 min-h-screen px-6 font-sans md:px-12 lg:px-12 lg:py-0">
        <div className="lg:flex lg:gap-12 relative">
          ...
          <header className="hidden lg:flex py-12 lg:sticky lg:top-0 lg:h-screen lg:w-[280px] lg:shrink-0 lg:flex-col lg:justify-between lg:py-24 overflow-y-auto no-scrollbar z-50">
            <Sidebar />
          </header>

          <main className="flex-1 pt-8 pb-32 lg:pt-24 lg:pb-0 min-w-0 w-full lg:max-w-7xl">
            {children}
          </main>
